...
powershell -NoProfile -Command "$proc=Start-Process -FilePath '!PY!' -ArgumentList '-u','main.py','all' -WorkingDirectory '!DIR!' -WindowStyle Hidden -PassThru; $proc.Id | Set-Content '!PID_FILE!'" 
